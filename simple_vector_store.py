...
class SimpleVectorStore:
    ...
    DEPRECATED: This class is deprecated. Please use PgVectorStore from storage.pg_vector_store instead.
    PgVectorStore provides better scalability, ACID compliance, and production-ready features.
    
    Migration: Replace `from simple_vector_store import SimpleVectorStore` 
    ...
    def __init__(
        ...
        import warnings
        warnings.warn(
            "SimpleVectorStore is deprecated. Use PgVectorStore from storage.pg_vector_store instead.",
            DeprecationWarning,
            stacklevel=2
        )
